...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_LCTL, MO(2), KC_NO, KC_LGUI, KC_ENT, KC_SPC, KC_RALT, KC_RSFT, KC_NO, TG(3)
  ),
  [1] = LAYOUT(
    ...
    KC_TRNS, KC_TRNS, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, RESET
  ),
  [2] = LAYOUT(
    ...
    KC_TRNS, KC_TRNS, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_TRNS
  ),
  [3] = LAYOUT(
